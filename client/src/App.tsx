...
function App() {
  ...
  const getPrompt = (input: CreativeInput) => {
    ...
    return `生成恰好${count}条短剧广告引流素材创意，结合传播学与心理学知识，生成高点击率、高转化率的创意内容。
...
### 1. 注意力捕获（Attention）
- 利用"认知缺口"制造信息缺口感，让用户想知道"后续发生了什么"
- 开头3秒必须抓住眼球：用异常画面、冲突台词、悬念问题
- 利用"祖母法则"：先说用户最关心的结果/好处

### 2. 情绪共鸣（Emotion）
- 激发情绪：好奇、惊讶、愤怒、焦虑、羡慕、爽感
- 利用"损失厌恶"：强调"错过就没了"、"仅限今天"
- 利用"社会认同"：展示大家都在看/都在买

### 3. 认知反差（Cognitive Dissonance）
- 利用错位制造认知冲突：身份反差、场景反差、预期反差
- 让用户产生"这不可能但又发生了"的感觉
- 越大反差越好，但要合理可执行
...
2. 利用${dislocationType}制造强烈认知反差和情绪冲击
